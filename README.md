...
Notion の家計簿データベースから月次の入出金を集計し、繰越ページの自動生成とメール／Slack でのレポート配信を行う Laravel 11 製 API・管理ツールです。さらに、銀行残高と手持ち現金との差異を調整するための Web フォームを提供し、パスキー（FIDO2）もしくはハッシュ済みクレデンシャルで安全に運用できます。
